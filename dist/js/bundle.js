...
_vue2.default.component('create-todo', {
  props: ['value', 'errflg'],
  data: function data() {
    return {
      errMsg: '入力が空です'
...
_vue2.default.component('search-box', {
  props: ['value'],
...
_vue2.default.component('todo-task', {
  props: ['todo'],
  methods: {
    ...
    openEditTodo: function openEditTodo(todo) {
      this.$emit('open-edit-todo', todo);
    },

    closeEditTodo: function closeEditTodo(todo) {
...
new _vue2.default({
  ...
  data: {
    ...
    errflg: false,
    count: 3,
    todos: [{ id: 1, title: 'sample todo 01', isDone: false, editText: false }, { id: 2, title: 'sample todo 02', isDone: false, editText: false }]
  },
  computed: {
    filteredTodo: function filteredTodo() {

      var todos = [];
      var regExp = new RegExp('^' + this.searchWord);
